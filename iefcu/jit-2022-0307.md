...
* 容器云平台, 组件介绍, 例如有监控，ci/cd, 存储，网络啥的

devops问题:
* 1.介绍devops
  CI/CD自
* DevOps⽂化建设及CI/CD⾃动化⼯具链的建设
  多集群devops怎么弄的？

* 蓝绿部署啥的怎么做的?

* 全平台监控、⽇志收集、和告警系统的设计部署

监控
举个例子，mysql这个服务，监控一些什么指标

然后，监控api耗时？

* Mysql，Redis，Kafka，Rabbitmq，Flink，Cliclkhouse等。
  部署模式, 例如今天刚好看到redis的集群部署
  => 总结部署相同点，差异点等

* 权限的设计，例如grafana赋予权限，跟k8s平台账号的权限?

=> 负责全平台⽹络及存储架构在私有云/公有云上的⽅案设计和技术实现
* 网络再详细讲讲，vpc peering打通部⻔内的私⽹通信, 是什么意思？
* 块存储，文件存储区别, 测试环境下用什么？
