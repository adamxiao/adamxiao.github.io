* 域名：`https://www.name.com/zh-cn/domain/search/23232354.xyz`
* 一键脚本：`https://github.com/wulabing/V2Ray_ws-tls_bash_onekey`
* 你可以搞一下谷歌云，那个可以免费一年  在那上面搭建
* 这个好处在于 加密很隐蔽 跟普通上网没区别 不容易被gfw分别出来 也就不容易被封
* https://github.com/yanue/V2rayU  Mac用这个客户端
